...
class ClientHandler extends Thread
{
	...
	public void run()
	{
		String received,username,pin,nopol,nopolk;
		...
		do
			...
			if (menu == 1){
				...
				DB_Paris.tmbhDataN(received);
                        ...
                        nopolk = input.next();
                        System.out.println(nopolk);
                        DB_Paris.setKeluarN(nopolk);
                        }
